...
public class Validations {
    ...
    /**
     * Utiliser pour le choix de l'option dans le menu 5 et le sous menu 5 -> a
     * caracteresAcceptes (prendra la valeur OPTIONS_ENTREE_NOTES pour la validation du choix saisi de l'option 5
     * et prendra la valeur OPTIONS_ENTREE_NOTES_TOUS_ETUDIANTS pour la validation du choix saisi de l'option 5 -> a
     * 2 usages
     *
